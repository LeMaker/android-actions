...
if(cfg_dts.rotate == 90 || cfg_dts.rotate == 270){
     input_set_abs_params(ts->pen_dev, ABS_MT_POSITION_X, 0, ts->abs_y_max, 0, 0);
     input_set_abs_params(ts->pen_dev, ABS_MT_POSITION_Y, 0, ts->abs_x_max, 0, 0);
}else{
