...
#endif /* CONFIG_MP_INCLUDED */
#ifdef CONFIG_BT_COEXIST
			rtw_btcoex_BtMpInfoNotify(padapter, pC2hEvent->plen, pC2hEvent->payload);
#endif /* CONFIG_BT_COEXIST */
			break;
...
#endif /* CONFIG_MP_INCLUDED */
#ifdef CONFIG_BT_COEXIST
			rtw_btcoex_BtMpInfoNotify(padapter, pC2hEvent->CmdLen, c2hBuf);
#endif /* CONFIG_BT_COEXIST */
			break;
...
//					rtw_btcoex_MediaStatusNotify(padapter, RT_MEDIA_CONNECT);
		...
		case HW_VAR_H2C_BT_MP_OPER:
			rtl8723b_set_FwBtMpOper_cmd(padapter, val[1], val[0]&0xF, val[0]>>4, val+2);
			break;
