 ...
 *
 * owl Phy register definitions
 *
 * SPDX-License-Identifier:	GPL-2.0+
 */

#ifndef _ASM_ARCH_XHCI_OWL_H_
#define _ASM_ARCH_XHCI_OWL_H_
...
extern void dwc3_clk_init(void);
extern void dwc3_clk_exit(void);
extern void owl_usb3_open_powergate(void);
extern void enable_bias(void);
extern void disable_bias(void);
#endif /* _ASM_ARCH_XHCI_OWL_H_ */
