...
if [ "$BOARD_NAME" =  "lemaker_guitar_bbb" ];then
		...
		cp ../owl/s500/boards/android/lemaker_guitar_bbb/os-eng.mk   ../owl/s500/boards/android/lemaker_guitar_bbb/os.mk 
		...
		cp ../owl/s500/boards/android/lemaker_guitar_bbb_plus/os-eng.mk   ../owl/s500/boards/android/lemaker_guitar_bbb_plus/os.mk 
