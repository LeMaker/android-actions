...
TARGET_BOOTLOADER_BOARD_NAME := lemaker_guitar_bba

BOARD_EGL_CFG := device/actions/lemaker_guitar_bba/egl.cfg
TARGET_BOARD_INFO_FILE := device/actions/lemaker_guitar_bba/board-info.txt
...
-include device/actions/lemaker_guitar_bba/wifi.mk
#
BOARD_SEPOLICY_DIRS += device/actions/lemaker_guitar_bba/sepolicy
