...
import com.actions.camera.app.AppManagerFactory;
import com.actions.camera.app.PlaceholderManager;
import com.actions.camera.app.PanoramaStitchingManager;
import com.actions.camera.crop.CropActivity;
import com.actions.camera.data.CameraDataAdapter;
import com.actions.camera.data.CameraPreviewData;
import com.actions.camera.data.FixedFirstDataAdapter;
import com.actions.camera.data.FixedLastDataAdapter;
import com.actions.camera.data.InProgressDataWrapper;
import com.actions.camera.data.LocalData;
import com.actions.camera.data.LocalDataAdapter;
import com.actions.camera.data.LocalMediaObserver;
import com.actions.camera.data.MediaDetails;
import com.actions.camera.data.SimpleViewData;
import com.actions.camera.tinyplanet.TinyPlanetFragment;
import com.actions.camera.ui.ModuleSwitcher;
import com.actions.camera.ui.DetailsDialog;
import com.actions.camera.ui.FilmStripView;
...
import com.actions.camera.util.PhotoSphereHelper;
import com.actions.camera.util.PhotoSphereHelper.PanoramaViewHelper;
...
import static com.actions.camera.CameraManager.CameraOpenErrorCallback;
...
public class CameraActivity extends Activity
    ...
    public static final String ACTION_TRIM_VIDEO =
            "com.actions.camera.action.TRIM";
    ...
    public void onModuleSelected(int moduleIndex) {
        ...
        Log.w(TAG, "onModuleSelected  mLastRawOrientation: "+mLastRawOrientation);
        if(gsensor!=null){				//if no Gsensor; no need to change Orientation,just keep default value
