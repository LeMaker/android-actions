...
public class WideAnglePanoramaModule
    ...
    public void startCapture() {
        ...
        int cameraId = mUsingFrontCamera ? CameraHolder.instance().getFrontCameraId() : CameraHolder.instance().getBackCameraId();
    ...
    /* This function is added to pass UI the info. about front or back camera. */
    public int getCurrentCameraType() {
        if (mUsingFrontCamera) return 1;
        else return 0;
    }
