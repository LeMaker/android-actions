...
#define FIRMWARE_DIRECTORY "/system/etc/firmware/rtl8723bs_vq0/"
#define BT_CONFIG_DIRECTORY "/system/etc/firmware/rtl8723bs_vq0/"
        ...
        uint32_t* config_baud_rate, char * config_file_short_name)
{
	...
	sprintf(bt_config_file_name, BT_CONFIG_DIRECTORY"rtl8723b_VQ0_config");
