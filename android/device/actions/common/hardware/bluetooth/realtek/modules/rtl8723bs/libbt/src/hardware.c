...
#define FIRMWARE_DIRECTORY "/system/etc/firmware/rtl8723bs/"
#define BT_CONFIG_DIRECTORY "/system/etc/firmware/rtl8723bs/"
...
static patch_info patch_table[] = {
    ...
    { ROM_LMP_8723b, "rtl8723b_fw", "rtk8723_bt_config"},     //Rtl8723BS
...
static const char *get_firmware_name()
{
	...
	sprintf(firmware_file_name, FIRMWARE_DIRECTORY"rtl8723b_fw");
        ...
        uint32_t* config_baud_rate, char * config_file_short_name)
{
	...
	sprintf(bt_config_file_name, BT_CONFIG_DIRECTORY"rtk8723_bt_config");
...
int rtk_get_bt_firmware(uint8_t** fw_buf, size_t addi_len, char* fw_short_name)
{
    ...
    sprintf(filename, FIRMWARE_DIRECTORY"rtl8723b_fw");
