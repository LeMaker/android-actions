...
#ifndef Action_OMX_PLUGIN_H_

#define Action_OMX_PLUGIN_H_
...
struct ActionOMXPlugin : public OMXPluginBase {
    ActionOMXPlugin();
    virtual ~ActionOMXPlugin();
...
private:
    ...
    ActionOMXPlugin(const ActionOMXPlugin &);
    ActionOMXPlugin &operator=(const ActionOMXPlugin &);
};

}  // namespace android

#endif  // Action_OMX_PLUGIN_H_
