/**
 @file components/omx_vce/src/library_entry_point.c
...
int omx_component_library_Setup(ActComponentType *stComponents)
{
	...
	strncpy(stComponents[0].name, VIDEO_ENC_COMP_NAME, OMX_MAX_STRINGNAME_SIZE);
	...
	strncpy(stComponents[0].libname, VIDEO_ENC_COMP_LIBNAME, OMX_MAX_STRINGNAME_SIZE);
	...
	for (i = 0; i < stComponents[0].name_specific_length; i++)
	{
		strncpy(stComponents[0].name_specific[i], VIDEO_ENC_COMP_NAME, OMX_MAX_STRINGNAME_SIZE);
		stComponents[0].name_specific[i][OMX_MAX_STRINGNAME_SIZE - 1] = '\0';
	}
	...
	strncpy(stComponents[0].role_specific[0], VIDEO_ENC_COMP_ROLE, OMX_MAX_STRINGNAME_SIZE);
	stComponents[0].role_specific[0][OMX_MAX_STRINGNAME_SIZE - 1] = '\0';
	strncpy(stComponents[0].role_specific[1], JPEG_ENC_COMP_ROLE, OMX_MAX_STRINGNAME_SIZE);
	stComponents[0].role_specific[1][OMX_MAX_STRINGNAME_SIZE - 1] = '\0';
	strncpy(stComponents[0].role_specific[2], IPP_ENC_COMP_ROLE, OMX_MAX_STRINGNAME_SIZE);
	stComponents[0].role_specific[2][OMX_MAX_STRINGNAME_SIZE - 1] = '\0';
	...
	ERR_HANDLE: if (stComponents[0].name != NULL)
	{
