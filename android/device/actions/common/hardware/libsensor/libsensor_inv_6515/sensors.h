...
static struct sensor_t sBaseSensorList[] =
{
    {"MPL Gyroscope", "Invensense", 1,
	 ...
	 {(void*)"mpu6515"}},// reserved[0] --> device name
    ...
    {"MPL Magnetic Field", "Invensense", 1,
	 ...
	 10000,
	 SENSOR_FLAG_CONTINUOUS_MODE,	 
	 {(void*)"AK8963"}},// reserved[0] --> device name
    ...
    {"MPL Magnetic Field", "Invensense", 1,
	 ...
	 10000,
	 SENSOR_FLAG_CONTINUOUS_MODE,	 
	 {(void*)"AK8975"}},// reserved[0] --> device name
    {"MPL Raw Magnetic Field", "Invensense", 1,
     SENSORS_RAW_MAGNETIC_FIELD_HANDLE,
     SENSOR_TYPE_MAGNETIC_FIELD_UNCALIBRATED, 10240.0f, 1.0f, 0.5f, 10000, 0, 128, 
	 SENSOR_STRING_TYPE_MAGNETIC_FIELD_UNCALIBRATED,
	 ...
	 10000,
	 SENSOR_FLAG_CONTINUOUS_MODE,	 
	 {(void*)"AK09911"}},// reserved[0] --> device name
    {"MPL Raw Magnetic Field", "Invensense", 1,
     SENSORS_RAW_MAGNETIC_FIELD_HANDLE,
     SENSOR_TYPE_MAGNETIC_FIELD_UNCALIBRATED, 10240.0f, 1.0f, 0.5f, 10000, 0, 128, 
	 SENSOR_STRING_TYPE_MAGNETIC_FIELD_UNCALIBRATED,
    ...
    {"MPL Screen Orientation", "Invensense ", 1,
     ...
     SENSOR_TYPE_SCREEN_ORIENTATION, 100.0f, 1.0f, 1.1f, 0, 0, 0, {(void*)"mpu6515"}},// reserved[0] --> device name
#endif
    {"LTR-301 Light sensor","LITE-ON",
