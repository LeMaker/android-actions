...
ANDROID_LINK_EXECUTABLE += -Wl,-dynamic-linker,/system/bin/linker64 -pie
...
ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libc/kernel/uapi
ANDROID_INCLUDES += -I$(ANDROID_ROOT)/bionic/libc/kernel/uapi/asm-arm64
