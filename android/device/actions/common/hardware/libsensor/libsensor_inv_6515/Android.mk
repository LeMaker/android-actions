...
#ifeq ($(BOARD_SENSOR_VENDOR), inv_6515)
...
#$(shell $(call _remove_temp_actions_codec,sensors.ATM900X))
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/$(BIN_PATH)/software/core/mllite
LOCAL_C_INCLUDES += $(LOCAL_PATH)/$(BIN_PATH)/software/core/mllite/linux
LOCAL_C_INCLUDES += $(LOCAL_PATH)/$(BIN_PATH)/software/core/driver/include
LOCAL_C_INCLUDES += $(LOCAL_PATH)/$(BIN_PATH)/software/core/driver/include/linux
...
LOCAL_C_INCLUDES += $(LOCAL_PATH)/$(BIN_PATH)/software/core/mpl
...
LOCAL_MODULE := sensors.${TARGET_BOARD_PLATFORM}.GYRO
...
LOCAL_SRC_FILES := $(BIN_PATH)/software/core/mpl/build/android/libmplmpu.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_OWNER := invensense
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
#LOCAL_MODULE_RELATIVE_PATH := $(TARGET_OUT)/lib
...
LOCAL_SRC_FILES := $(BIN_PATH)/software/core/mllite/build/android/libmllite.so
LOCAL_MODULE_TAGS := optional
LOCAL_MODULE_OWNER := invensense
LOCAL_MODULE_SUFFIX := .so
LOCAL_MODULE_CLASS := SHARED_LIBRARIES
...
LOCAL_MODULE :=getevent_iio
LOCAL_SRC_FILES :=$(BIN_PATH)/software/simple_apps/getevent_iio/build/android/getevent_iio
...
LOCAL_MODULE :=inv_self_test-shared
LOCAL_SRC_FILES :=$(BIN_PATH)/software/simple_apps/self_test/build/android/inv_self_test-shared
LOCAL_MODULE_TAGS :=eng optional
LOCAL_MODULE_CLASS :=etc
LOCAL_MODULE_PATH := $(TARGET_OUT)/bin
include $(BUILD_PREBUILT)
