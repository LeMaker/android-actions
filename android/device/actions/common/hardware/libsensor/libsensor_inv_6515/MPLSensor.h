...
private:
    ...
    void fillAccel(const char* accel, struct sensor_t *list,int len);
    void fillGyro(const char* gyro, struct sensor_t *list,int len);
    void fillRV(struct sensor_t *list,int len);
    void fillGMRV(struct sensor_t *list,int len);
    void fillGRV(struct sensor_t *list,int len);
    void fillOrientation(struct sensor_t *list,int len);
    void fillGravity(struct sensor_t *list,int len);
    void fillLinearAccel(struct sensor_t *list,int len);
    void fillSignificantMotion(struct sensor_t *list,int len);
#ifdef ENABLE_DMP_SCREEN_AUTO_ROTATION
    void fillScreenOrientation(struct sensor_t *list,int len);
#endif
