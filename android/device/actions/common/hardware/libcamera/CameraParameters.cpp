...
const char CameraProperties::FOCUS_DISTANCES[] = "prop-focal-distances";
const char CameraProperties::HOR_ANGLE[] = "prop-horizontal-angle";
const char CameraProperties::VER_ANGLE[] = "prop-vertical-angle";
const char CameraProperties::PREVIEW_FRAMERATE_RANGE[] = "prop-preview-framerate-range-default";
const char CameraProperties::IMAGE_FRAMERATE_RANGE[] = "prop-image-framerate-range-default";
...
const char CameraProperties::MAX_REAL_FOCUS_AREAS[] = "prop-max-real-focus-areas";
...
const char CameraProperties::AUTO_FOCUS_LOCK[] = "prop-auto-focus-lock";
const char CameraProperties::AUTO_FOCUS_LOCK_SUPPORTED[] = "prop-auto-focus-lock-supported";
...
const char CameraProperties::IMAGE_FRAMERATE_RANGE_SUPPORTED[] = "prop_image_framrate_range_supported";
const char CameraProperties::PREVIEW_FRAMERATE_RANGE_SUPPORTED[] ="prop_preview_framrate_range_supported";
const char CameraProperties::CONTRAST_SUPPORTED[] ="prop_contrast_supported";
const char CameraProperties::SATURATION_SUPPORTED[]="prop_saturation_supported";
const char CameraProperties::BRIGHTNESS_SUPPORTED[]="prop_brightness_supported";
const char CameraProperties::SHARPNESS_SUPPORTED[]="prop_sharpness_supported";
const char CameraProperties::DENOISE_SUPPORTED[]="prop_denoise_supported";
const char CameraProperties::ISO_SUPPORTED[]="prop_iso_supported";
const char CameraProperties::FLASH_SUPPORTED[]="prop_flash_supported";
const char CameraProperties::FOCUS_SUPPORTED[]="prop_focus_supported";
const char CameraProperties::ANTIBANDING_SUPPORTED[]="prop_antibanding_supported";



const char CameraProperties::SUPPORTED_CONTRAST_MIN[] = "prop_contrast_min";
const char CameraProperties::SUPPORTED_CONTRAST_MAX[] = "prop_contrast_max";
const char CameraProperties::SUPPORTED_CONTRAST_STEP[] = "prop_contrast_step";

const char CameraProperties::SUPPORTED_SATURATION_MIN[] = "prop_staturation_min";
const char CameraProperties::SUPPORTED_SATURATION_MAX[] = "prop_staturation_max";
const char CameraProperties::SUPPORTED_SATURATION_STEP[] = "prop_staturation_step";

const char CameraProperties::SUPPORTED_BRIGHTNESS_MIN[] = "prop_brightness_min";
const char CameraProperties::SUPPORTED_BRIGHTNESS_MAX[] = "prop_brightness_max";
const char CameraProperties::SUPPORTED_BRIGHTNESS_STEP[] = "prop_brightness_step";

const char CameraProperties::SUPPORTED_DENOISE_MIN[] = "prop_denoise_min";
const char CameraProperties::SUPPORTED_DENOISE_MAX[] =  "prop_denoise_max";
const char CameraProperties::SUPPORTED_DENOISE_STEP[]=  "prop_denoise_step";

const char CameraProperties::DENOISE[] = "prop-denoise-default";

const char CameraProperties::SCENE_SUPPORTED[] = "prop_scene_supported";
const char CameraProperties::EFFECT_SUPPORTED[] = "prop_effect_supported";
const char CameraProperties::WHITEBALANCE_SUPPORTED[] = "prop_whitebalance_supported";
