...
public:
    ...
    class DisplayThread : public Thread
    {
        ...
        ActUtils::MessageQueue mDisplayThreadQ;
...
private:
    ...
    ActUtils::MessageQueue mDisplayQ;
    ...
    buffer_handle_t* mGrallocHandleMap;//
    ...
    unsigned char *mConvBuf;
#endif

#ifdef CAMERA_FRAME_STAT

    int *mStatLagTime;
    unsigned long long *mStatLagTimeStamp;
    int *mStatFlyTime;
    int *mStatCaptureIntervalTime;
    int *mStatCaptureScheTime;
    int mStatLagCount;
    float mStatFps;
    int mStatFrameCount;
    unsigned long long mStatStartTime;
    unsigned long long mStatLastTime;
    bool mStatStarted;

    void statInit();
    void statSaveInfo();
    void statFrame(CameraFrame* caFrame);
    void statAllocBuffer();
    void statFreeBuffer();
