...
#ifndef CAMERA_CONVERTERS_H
#define CAMERA_CONVERTERS_H
 ...
 *  width, height - Dimensions for both framebuffers.
 */
void YU12ToRGB565(const void* yu12, void* rgb, int width, int height);
...
/* Converts an RGB565 framebuffer to NV21 framebuffer.
 * Param:
 *  rgb - RGB565 framebuffer.
 *  nv12 - NV12 framebuffer.
 *  width, height - Dimensions for both framebuffers.
