...
#define CAMERA_COMP_NAME "OMX.Action.Video.Camera.Test"
#define CAMERA_COMP_ROLE "camera_source"
#define MAX_CAMERA_COMPONENTS 1

#define MAX_CAMERA_NUMS  (2)

/* Camera Component Port Index */
enum
{
    OMX_CAMPORT_INDEX_VF = 0, /* preview/video port */
    OMX_CAMPORT_INDEX_CP,       /* image port */
    OMX_CAMPORT_INDEX_MAX
};


#define NUM_CAMERA_VIDEO_PORTS (1)
#define NUM_CAMERA_IMAGE_PORTS (1)
#define CAMERA_VIDEO_PORT_START (0)
#define CAMERA_IMAGE_PORT_START (NUM_CAMERA_VIDEO_PORTS)

#define V4L2DEV_FILENAME  "/dev/video"

#define V4L2_CAMERA_DEV_MINOR_0 (0)
#define V4L2_CAMERA_DEV_MINOR_1 (3)
#define V4L2_CAMERA_DEV_MINOR_2 (4)
...
/** Camera source component port structure.
  */
DERIVEDCLASS(omx_camera_source_component_video_PortType, omx_base_video_PortType)
#define omx_camera_source_component_video_PortType_FIELDS omx_base_video_PortType_FIELDS \
  OMX_BOOL bIsStoreMetaData;
ENDCLASS(omx_camera_source_component_video_PortType)

DERIVEDCLASS(omx_camera_source_component_image_PortType, omx_base_image_PortType)

#define omx_camera_source_component_image_PortType_FIELDS omx_base_image_PortType_FIELDS \
    OMX_BOOL bIsStoreMetaData;
ENDCLASS(omx_camera_source_component_image_PortType)
...
#define omx_camera_source_component_PrivateType_FIELDS omx_base_source_PrivateType_FIELDS \
  ...
  int ion_fd;                       \
  OMX_PARAM_SENSORSELECTTYPE sSensorType; \
  OMX_BOOL  bDeviceStarted; \
