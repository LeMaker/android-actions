...
TARGET_BOOTLOADER_BOARD_NAME := lemaker_guitar_bbd

BOARD_EGL_CFG := device/actions/lemaker_guitar_bbd/egl.cfg
TARGET_BOARD_INFO_FILE := device/actions/lemaker_guitar_bbd/board-info.txt
...
-include device/actions/lemaker_guitar_bbd/wifi.mk
#
BOARD_SEPOLICY_DIRS += device/actions/lemaker_guitar_bbd/sepolicy
