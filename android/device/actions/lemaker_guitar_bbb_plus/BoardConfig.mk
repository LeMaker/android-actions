...
TARGET_BOOTLOADER_BOARD_NAME := lemaker_guitar_bbb_plus

BOARD_EGL_CFG := device/actions/lemaker_guitar_bbb_plus/egl.cfg
TARGET_BOARD_INFO_FILE := device/actions/lemaker_guitar_bbb_plus/board-info.txt
...
-include device/actions/lemaker_guitar_bbb_plus/wifi.mk
#
BOARD_SEPOLICY_DIRS += device/actions/lemaker_guitar_bbb_plus/sepolicy
