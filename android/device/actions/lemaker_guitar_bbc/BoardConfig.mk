...
TARGET_BOOTLOADER_BOARD_NAME := lemaker_guitar_bbc

BOARD_EGL_CFG := device/actions/lemaker_guitar_bbc/egl.cfg
TARGET_BOARD_INFO_FILE := device/actions/lemaker_guitar_bbc/board-info.txt
...
-include device/actions/lemaker_guitar_bbc/wifi.mk
#
BOARD_SEPOLICY_DIRS += device/actions/lemaker_guitar_bbc/sepolicy
