...
public:
    //static const int MAX_PARTITIONS = 16; //modify for multi parts
protected:
    ...
    int            mDiskMajor;
    int            mDiskMinor;
    //int            mPartMinors[MAX_PARTITIONS];    //modify for multi parts
    int            mOrigDiskMajor;
    int            mOrigDiskMinor;
    int            mOrigPartMinors[MAX_PARTITIONS];
    //int            mDiskNumParts;       //modify for multi parts
