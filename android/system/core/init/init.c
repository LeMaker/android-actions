...
static void export_kernel_boot_props(void)
{
    ...
    struct {
        ...
        /*
		 *fix prop default value for cts
		 *ActionsCode(author:songzhining, type:change_code)
		 */
		{ "ro.boot.mode", "ro.bootmode", "normal", },
        { "ro.boot.baseband", "ro.baseband", "", },
        { "ro.boot.bootloader", "ro.bootloader", "uboot-gs705a", },
		/*
		 *support bootdev dvfslevel prop by command line
		 *ActionsCode(author:liaotianyang, type:change_code)
		 */
        { "ro.boot.dvfslevel", "ro.dvfslevel", "unknown", },        
        { "ro.boot.product.devicenumber", "ro.product.devicenumber", "", },
		{ "ro.boot.bootdev", "ro.bootdev", "nand", },  
    };
...
#if BOOTCHART
    // ActionsCode(authro:songzhining, comment: queue bootchart_init after mount fs)
