...
LOCAL_WHOLE_STATIC_LIBRARIES := \
   ...
   LOCAL_WHOLE_STATIC_LIBRARIES +=libprofile
...
#LOCAL_C_INCLUDES := $(libc_common_c_includes)
#LOCAL_CFLAGS := $(libc_common_cflags)
#LOCAL_SRC_FILES := profile.cpp open_ext.c pa_area.c
...
# ========================================================
# libprofile.a -   profiling C library code
# ========================================================

include $(CLEAR_VARS)
LOCAL_SRC_FILES_32 := libprofile_32.a
LOCAL_SRC_FILES_64 := libprofile_64.a
LOCAL_BUILT_MODULE_STEM := libprofile.a
