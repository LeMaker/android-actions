...
#
include $(CLEAR_VARS)
LOCAL_MODULE    := libbootburn
ifneq ($(TARGET_IS_64_BIT),true)
ifeq ($(filter $(TARGET_PRODUCT),full_gs900a),)
LOCAL_SRC_FILES := libbootw_705a.a
else
LOCAL_SRC_FILES := libbootw_900a.a
endif
else
LOCAL_SRC_FILES := libbootw_64.a
endif
...
include $(CLEAR_VARS)
LOCAL_SRC_FILES := mkfs_vfat.c
LOCAL_MODULE := libmkfs_vfat
LOCAL_MODULE_TAGS := eng
...
LOCAL_STATIC_LIBRARIES += libbootburn
LOCAL_STATIC_LIBRARIES += libcutils liblog libstdc++ libc  libmkfs_vfat 
