...
public class MediaScannerService extends Service implements Runnable
{
    ...
    //ActionsCode(author:lishiyuan, change_code)
        ...
        public void handleMessage(Message msg)
        {
            ...
            try {
                if (filePath != null) {
                    ...
                    try {
                        if (LOCAL_LOGD) 
                            Log.d(TAG, "start scanning file " + filePath);
                    ...
                    String directoryPath = arguments.getString("directorypath");
                    ...
                    if( directoryPath != null){
                        ...
                        volume = MediaProvider.EXTERNAL_VOLUME;
                    ...
                    if (directories != null && volume != null) {
                        if (LOCAL_LOGD) 
                            Log.d(TAG, "start scanning volume:" + volume + " directories: "
                ...
                //ActionsCode(authro:lishiyuan, BUGFIX:BUG00101706 and BUG00100247:)
                //add by wgh
                MediaProvider.scanning = false;
               
            }

            stopSelf(msg.arg1);
			Log.d(TAG, "end handleMessage");
        }
    };
}
