    ...
    */
    ...
    public void onResume() {
        ...
        if (mHaveDebugSettings && !mLastEnabledState) {
            ...
            //ActionsCode(phchen, NEW FEATURE, dont enabled development when CTS mode ), 
		...
		mLastEnabledState = true;
                ...
                Settings.Global.putInt(getActivity().getContentResolver(),Settings.Global.PACKAGE_VERIFIER_INCLUDE_ADB, 0);
    ...
    private void writeBtHciSnoopLogOptions() {
        ...
        //ActionsCode(phchen, bugfix BUG00160561), 
		if(adapter==null)
			return;
