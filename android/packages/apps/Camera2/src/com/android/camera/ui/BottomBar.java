...
public class BottomBar extends FrameLayout {
    ...
    // ActionsCode(authro:songzhining, comment: fix drawable leak bug)
    private Drawable mShutterButtonDrawable = null;
    ...
    public void setShutterButtonIcon(int resId) {
        ...
        // ActionsCode(authro:songzhining, comment: fix drawable leak bug)
        mShutterButtonDrawable = iconDrawable;
    }
    ...
    public void animateToVideoStop(int resId) {
        ...
        TransitionDrawable transitionDrawable = crossfadeDrawable(
                mShutterButtonDrawable,  // ActionsCode(authro:songzhining, comment: fix drawable leak bug)
