...
public class CameraSettingsActivity extends FragmentActivity {
    ...
    public static class CameraSettingsFragment extends PreferenceFragment implements
        ...
        /**
         *
         * Check if the pref pointer is null
         * ***********************************
         * *
   	...
   	*/
	    ...
	    {
		String uvc_key = "ro.camerahal.uvc_replacemode";
	        String NON_UVC = "0";
	        String UVC_Rear = "1";
	        String UVC_Front = "2";
	        String val = SystemProperties.get(uvc_key, NON_UVC);
	        if(UVC_Rear.equals(val)||UVC_Front.equals(val)){
	            refresh =true;
		}
            }
            // Back camera.
            ...
            if (backCameraId >= 0) {
                ...
                mVideoQualitiesBack = SettingsUtil.getSelectedVideoQualities(backCameraId, refresh);
            } else {
            ...
            if (frontCameraId >= 0) {
                ...
                mVideoQualitiesFront = SettingsUtil.getSelectedVideoQualities(frontCameraId, refresh);
            } else {
