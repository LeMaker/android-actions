...
public class CameraAppUI implements ModeListView.ModeSwitchListener,
    ...
    /***************************Mode options api *****************************/
	//ActionsCode(liyuan, change_code),avoid click fluent confusion for recond
    /**
     * Set the mode options visible.
     */
    public void showModeOptions(boolean show) {
    	if(show)
    	{
    ...
    /**
     *
     * MERGEFIX:  Merge Android 5.1 deal with BUTTON_TORCH.
     *
     ************************************
     * 
