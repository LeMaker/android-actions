...
public class CameraActivity extends QuickActivity
    ...
    *ActionsCode(author:liyuan, change_code)
    */
    public void setStorageSpaceListener(OnStorageUpdateDoneListener callback ) {
        mStorageSpaceListener = callback;
    }
    ...
    /**
     *
     * Get rid of AsyncTask, for it will cause destroy activity in some case.
     * ***********************************
     *
    ...
    public void notifyNewMedia(Uri uri) {
        ...
        mDataAdapter.addData(newData);
        startPeekAnimation(newData, mCurrentModule.getPeekAccessibilityString());
    }
    ...
    public void onPauseTasks() {
        ...
        Log.i(TAG, "CameraActivity pause");
        /*
    ...
    /**
     *
     * Do not exec onModeSelected at the beginning of SecureCameraActivity.
     * ***********************************
     *
     * ActionsCode(author:liuyiguang, change_code)
     **/
    public void onStartTasks() {
        ...
        //ActionsCode(liuyiguang)
        if (!isCaptureIntent() && mCurrentModeIndex != modeIndex && !mSecureCamera) {
    ...
    protected void updateStorageHint(long storageSpace) {
	    ...
	    *ActionsCode(author:liyuan, change_code)
	    */
	    if(mStorageSpaceListener != null && !mPaused)
		mStorageSpaceListener.onStorageUpdateDone(storageSpace);
        }
   ...
   /*add by daihongbo; if no Gsensor no need to do this any more*/
