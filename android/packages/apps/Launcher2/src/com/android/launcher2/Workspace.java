...
public class Workspace extends SmoothPagedView
    ...
    */
    public Workspace(Context context, AttributeSet attrs, int defStyle) {
        ...
        if(!Utilities.mWorkspaceConfig){//hava not exist config,run google native code
            ...
            if(isLandscape){//land
                cellCountX = Utilities.mWorkspaceLandX;
                cellCountY = Utilities.mWorkspaceLandY;
            }
            else{//port
                cellCountX = Utilities.mWorkspacePortX;
                cellCountY = Utilities.mWorkspacePortY;
            }
        }
    ...
    class WallpaperOffsetInterpolator {
        ...
        public void setFinalX(float x) {
            // ActionsCode(authro:songzhining, comment: fix BUG00218223, fix negtive offset for Arabic)
            x = Math.abs(x);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (LauncherApplication.isStillWallpaper() == false) {
        	updateWallpaperOffsets();
        } else {
        	if (mWindowToken != null) {
                mWallpaperManager.setWallpaperOffsets(mWindowToken, 0.0f, 0.5f);
            }
        } 
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            if (touchXY != null) {
                ...
                // ActionsCode(phchen, BUGFIX: BUG00275340),
		mAddToExistingFolderOnDrop = true;
