    ...
    */
    public void calculateCellCount(int width, int height, int maxCellCountX, int maxCellCountY) {
        ...
        if(!Utilities.mCellConfig){
            ...
            if(isLandscape){
                mCellCountX = Utilities.mAllAppsLandX;
                mCellCountY = Utilities.mAllAppsLandY;
            }else{
                mCellCountX = Utilities.mAllAppsPortX;
                mCellCountY = Utilities.mAllAppsPortY;
            }
        }
        requestLayout();
    }
