...
public abstract class PagedView extends ViewGroup implements ViewGroup.OnHierarchyChangeListener {
    ...
    private static final int MIN_SNAP_VELOCITY = Utilities.MIN_SNAP_VELOCITY;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        for (int i = startIndex; i != endIndex; i += delta) {
            ...
            if (child.getVisibility() != View.GONE) {
            	...
            	//ActionsCode(phchen, BUGFIX: BUG00235303 , BUG00272973), 
               if ((mPageSpacing <= 0) && (getMeasuredWidth() !=  getChildWidth(0)) && (childLeft >= 0)){
                    mPageSpacing = childLeft;
                }
    ...
    */
    protected int getChildOffset(int index) {
        ...
        if (childOffsets != null && childOffsets[index] != -1) {
            ...
            //ActionsCode(phchen, BUGFIX: BUG00260125,BUG00272973 ), 
            if ((mPageSpacing <= 0) && (getMeasuredWidth() !=  getChildWidth(0)) && (offset >= 0)){
                mPageSpacing = offset;
            }
            for (int i = startIndex; i != endIndex; i += delta) {
