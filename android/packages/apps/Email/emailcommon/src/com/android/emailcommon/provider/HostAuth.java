...
public class HostAuth extends EmailContent implements Parcelable {
    ...
    */
    ...
    public void setConnection(String protocol, String address,
        ...
        mAddress = address;
        mPort = port;
        //ActionsCode(liuxinxu, OPTIMIZE:set right port number for different security type)
        if (mPort == PORT_UNKNOWN) {
            ...
            if (SCHEME_POP3.equals(mProtocol)) {
                ...
                mPort = useSSL ? 443 : 80;
            } else if (LEGACY_SCHEME_SMTP.equals(mProtocol)) {
