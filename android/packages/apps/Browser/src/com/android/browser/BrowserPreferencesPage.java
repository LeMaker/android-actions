...
public class BrowserPreferencesPage extends PreferenceActivity {
    ...
    private static final Set<String> sKnownFragments = new HashSet<String>(Arrays.asList(
            ...
            "com.android.browser.preferences.UAPreferencesFragment",
            "com.android.browser.preferences.ADBPreferencesFragment"));

    /**
     * BrowserPreferencesPage should override the same method in PreferenceActivity,
     * if no the browser will crash when enter the submenu of settings
     * *****************************************************************************
     * ActionsCode(author:hexibin, new_method)
     */
    @Override
