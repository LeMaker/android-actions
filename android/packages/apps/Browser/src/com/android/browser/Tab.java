...
class Tab implements PictureListener {
    ...
    private final WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
        	//ActionsCode(hexibin, bugfix BUG00243089)
        	//Block network pictures loading until onPagefinish.
        	//mMainView.getSettings().setBlockNetworkImage(true);
        ...
        public void onPageFinished(WebView view, String url) {
        	//ActionsCode(hexibin, bugfix BUG00243089)
            //Block network pictures loading until onPagefinish.
        	//mMainView.getSettings().setBlockNetworkImage(false);
        ...
        public void doUpdateVisitedHistory(WebView view, String url,
                boolean isReload) {
        	//ActionsCode(hexibin, bugfix BUG00214239)
            syncCurrentState(view, url);
