    ...
    */
    ...
    public void onResume() {
        ...
        if (current != null) {
            ...
            //ActionsCode(liuxinxu, change_code:fix cts BrowserBenchTest bug)
            if(current.getWebView() != null && current.getUrl() != null
                    && current.getAppId() != null
                    && current.getAppId().equals("com.android.cts.browser")) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.history_menu_id:
                ...
                break;
/*
 * hexibin, remove no realize snapshots menu
...
*/
    ...
    */
    public void bookmarkCurrentPage() {
    	//ActionsCode(hexibin, bugfix BUG00306135)
