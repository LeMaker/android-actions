...
//      ActionsCode(author:inidhu, bugfix BUG00128872)
        } else if (bucketId == MediaSetUtils.SCREEN_RECORD_BUCKET_ID) {
            return res.getString(R.string.folder_screenrecord);
...
//          ActionsCode(author:inidhu, bugfix BUG00128872)
            ...
            relativePath += BucketNames.SCREENRECORDS;
        } else if (bucketId == MediaSetUtils.EDITED_ONLINE_PHOTOS_BUCKET_ID) {
