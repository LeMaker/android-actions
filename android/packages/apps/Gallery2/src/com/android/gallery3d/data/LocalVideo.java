...
public class LocalVideo extends LocalMediaItem {
    ...
    /**
      ...
      *ActionsCode(author:maijunhong, commit:change_code)
      */
    @Override
    public int getSupportedOperations() {
        //ActionsCode(author:inidhu, comment:trim video not supported now)
    	//ActionsCode(author:maijunhong, comment:fix BUG00286822, mute video not supported now) 
