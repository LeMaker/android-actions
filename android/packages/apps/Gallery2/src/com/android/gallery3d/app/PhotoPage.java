...
public abstract class PhotoPage extends ActivityState implements
    ...
    /* 
     *ActionsCode(author:inidhu, type:change_code)
     */
    private void updateUIForCurrentPhoto() {
        ...
        //ActionsCode(authro:inidhu, comment:bugfix BUG00104896)
        if (!mPhotoView.getFilmMode()) {
            updateTitle();
        }
    ...
    /**
      *ActionsCode(author:inidhu, commit:new_method, bugfix BUG00104896)
      */
    ...
    /**
     * ActionsCode(author:inidhu, change_mode)
     */
    ...
    private void updateMenuOperations() {
        ...
        if (mReadOnlyView) {
//        	ActionsCode(author:inidhu, fix FAQ BUG00156370)
        ...
        if (mShowSpinner) {
            if (enabled) {
                mActionBar.setDisplayOptions(
                        ((mSecureAlbum == null) && (mSetPathString != null)), false); //add by inidhu, fix BUG00104896
                mActionBar.setTitle(mMediaSet != null ? mMediaSet.getName() : ""); //add by inidhu, fix BUG00104896
                mActionBar.enableAlbumModeMenu(
                        GalleryActionBar.ALBUM_FILMSTRIP_MODE_SELECTED, this);
            } else {
                mActionBar.setDisplayOptions(
                        ((mSecureAlbum == null) && (mSetPathString != null)), true); //add by inidhu, fix BUG00104896
                updateTitle(); //add by inidhu, fix BUG00104896
                mActionBar.disableAlbumModeMenu(true);
            }
        }
        if (enabled) {
    ...
    /**
      *ActionsCode(author:inidhu, commit:change_code)
      */
    @Override
