...
public class LocalImage extends LocalMediaItem {
     ...
     */
    @Override
    public Job<BitmapInfo> requestUriImage(Uri uri){
        return new BitmapJob(uri);
    }
     ...
     * ActionsCode(author:inidhu, new_method)
     */
    public class BitmapJob implements Job<BitmapInfo> {
        private Uri mUri;

        public BitmapJob(Uri uri) {
            mUri = uri;
        }

        @Override
        public MediaItem.BitmapInfo run(JobContext jc) {
            Context context = mApplication.getAndroidContext();
            com.android.gallery3d.util.BitmapUtils utils = new com.android.gallery3d.util.BitmapUtils(context);
            return new BitmapInfo(mUri, utils.getNotRotateBitmap(mUri, 1024, 768));
        }
    }
