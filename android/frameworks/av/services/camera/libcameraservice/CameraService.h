...
public:
	...
	virtual void event_handler(struct inotify_event *event);
	virtual void updateCameraNum();
	virtual void * monitor_uvc_hotplug();
    ...
    public:
        ...
        virtual void        notifyError2(ICameraDeviceCallbacks::CameraErrorCode errorCode,
	...
	class CameraAsyncTask : public Thread {
		
    public:
        CameraAsyncTask(void *func,void *params)
            :  Thread(false),mTask(func),mParams(params) { }
