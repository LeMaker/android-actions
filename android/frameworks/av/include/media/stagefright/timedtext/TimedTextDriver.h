...
public:
   ...
   //ActionsCode(author:sunchengzhi, new_method for create outofband subtitle)
    status_t createOutOfBandACTTextSource(
	size_t trackIndex, const char *mimeType,const sp<DataSource>& dataSource);
