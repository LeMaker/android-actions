...
enum {
    ...
    /*ActionsCode(author:sunchengzhi,keys defined by actions)*/
    kKeyActMediaInfo   			   = 'actm',  // pointer to media_info_t
    kKeyActVideoPrivateData        = 'actv',  // private data for video codecs
    ...
    kKeyActGLBL                       = 'glbl',   // Mpeg4 private data 
     



		kKeyActCookParserInfo          = 'accp',   // Cook private data
		kKeyActCookinterleaveInfo      = 'acci',   // Cook interleavePattern data
		kKeyActFrameSize               = 'acfz',   // frame size
		kKeyActAudioPrivateData        = 'acpd',    // actions audio decoders private data
		kKeyActChannelCount            = 'chng',    //actions audio decoder Channel Count
		kKeyActFirstVorbisBook         = 'vbok',   // actions verbis audio decoder special data
};
