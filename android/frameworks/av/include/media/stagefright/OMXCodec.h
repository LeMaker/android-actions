...
struct OMXCodec : public MediaSource,
    ...
    enum CreationFlags {
        ...
        /*ActionsCode(author:sunchengzhi, define flags to differentiate Android and Actions Extractors)*/
        kActUseAndroidExtractor =512,
        kActUseActionsExtractor = 1024,
    };
...
private:
    ...
    struct BufferInfo {
		...
		/*ActionsCode(author:rongxing,fix BUG00283278 for network is timeout)*/
	...
	//for actions codec specificdata
    char  *mActCodecSpecificData;
