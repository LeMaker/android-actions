...
public:
    ...
    bool needrefresh(const char **xmlpath);

    /**
     * Returns true if a profile for the given camera at the given quality exists,
     * or false if not.
     */
    bool hasCamcorderProfile(int cameraId, camcorder_quality quality) ;
...
private:
    ...
    int initCamcorderProfilesFromXmlFile(MediaProfiles *profiles, const char *xml);
    void initCamcorderProfiles();
    // Debug
    ...
    static bool sIsCamcorderInitialized;
    static long last_modify_time;
