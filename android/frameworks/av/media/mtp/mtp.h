...
/*actions mtp operation*/
#define ACTIONS_MTP_OPERATION									0x97ff
#define	ACTIONS_MODIFY_SERIAL									0x7f
#define	ACTIONS_MODIFY_SERIAL_RESTART						0x7e
#define	ACTIONS_GET_SERIAL									0xff
#define ACTIONS_SET_MISCINFO					0X7d
#define ACTIONS_GET_MISCINFO					0Xfd
#define ACTIONS_MISCINFO_MAX_LEN				(1024*8)
#define	ACTIONS_SWITCH_TO_ADFU								0xcb
#define	ACTIONS_GET_MTP_MANUFACTURER						0xcc
