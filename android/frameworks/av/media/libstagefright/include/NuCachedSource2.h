...
struct NuCachedSource2 : public DataSource {
    ...
    /*ActionsCode(author:sunchengzhi,new_method for bugfix:BUG00241678 )*/
    void setContentType(AString sniffedMIME);
    void enableTimedout();
    void disableTimedout();
...
private:
    ...
    bool mIsMp4;
    bool mTimedoutEnabled;
    bool mWaitCondition;
    int32_t mTimedoutcnt;
    int32_t mReadGeneration;
