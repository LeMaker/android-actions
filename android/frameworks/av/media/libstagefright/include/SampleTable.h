...
public:
...
#if 1//Add by act for pcm
	// type can be 'twos' or 'swot'
	status_t setDefaultSampleSizeParams(uint32_t sample_size);
#endif
...
#if 1 //Add by act for pcm
	void setCodecIDAndChannel(enum CodecID codecID , int32_t channleNum);
#endif
    ////////////////////////////////////////////////////////////////////////////
	...
	uint32_t getDefaultSampleSizeParams();
#endif
    enum {
        kFlagBefore,
        kFlagAfter,
...
private:
	...
	uint32_t *mSizeToSample;//Add by act
	...
	enum CodecID mCodecId;//Add by act for pcm
	int32_t mChannelNum;
