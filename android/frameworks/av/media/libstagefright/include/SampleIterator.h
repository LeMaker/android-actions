...
#if 1 
	// Add by ACT   for pcm decoder
	uint32_t getFirstChunkSampleIndex() const {return mFirstChunkSampleIndex; }
	// Add by ACT   for pcm decoder
	uint32_t getSamplesPerChunk() const {return mSamplesPerChunk; }
#endif
