...
/*
  * mp1&mp2 format use Actions decoder for compatibility test.
  ************************************
  *      
...
bool SniffMP3(
    ...
    *confidence = 0.2f;
	...
	/*ActionsCode(author:jinsongxue, mp1&mp2 use Actions decoder.)*/
	uint32_t layer = (header >> 17)&0x3;
	//ALOGE("JINSONG: layer=%d", layer);
    switch(layer){
    case 1:
    	break;
    case 3:
    	*mimeType = MEDIA_MIMETYPE_AUDIO_MPEG_LAYER_I;
    	return false;		
    case 2:
