...
class TimedTextSource : public RefBase {
 public:
  enum FileType {
      ...
      OUT_OF_BAND_FILE_ACT = 3,// ActionsCode(sunchengzhi,actions filetype for out of band subtitle)
  };
  ...
  // ActionsCode(sunchengzhi,new_method for create actions out of band source)
  static sp<TimedTextSource> CreateTimedTextExACTSource(
