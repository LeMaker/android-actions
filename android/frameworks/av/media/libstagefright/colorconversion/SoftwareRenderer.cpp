...
SoftwareRenderer::~SoftwareRenderer() {
 ...
 /**
  *
  *fix BUG00194635.display width and height is not 16 bytes aligned ,but gpu needs 16 bytes aligned  
  ************************************
  *      
...
void SoftwareRenderer::resetFormatIfChanged(const sp<AMessage> &format) {
	...
	//ActionsCode(sunchengzhi,bugfix BUG00194635)
...
/**
  *
  *fix BUG00164419.fix alignment of u,v in SoftwareRender,u,v just need 8 bytes aligned
  ************************************
  *      
  *ActionsCode(author:sunchengzhi, change_code)
  */
void SoftwareRenderer::render(
    ...
    if (mConverter) {
		...
		/*ActionsCode(sunchengzhi,bugfix BUG00164419,uv just need 8 aligned)*/
