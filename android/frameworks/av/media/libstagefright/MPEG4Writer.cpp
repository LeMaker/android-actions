...
/*ActionsCode(author:sunchengzhi, bugfix :BUG00208335
kMax32BitFileSize android original is 2^32-1 that is max FAT32.
we find that In practical applications,if the value is set to max FAT32,
then the longtime recorded video that size is 
approaching to max FAT32 will not be recognized at FAT32,
so we chang the kMax32BitFileSize to 2G)*/
