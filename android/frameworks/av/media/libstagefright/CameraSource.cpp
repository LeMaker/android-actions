...
static int32_t getColorFormat(const char* colorFormat) {
    if (!strcmp(colorFormat, CameraParameters::PIXEL_FORMAT_YUV420P)) {
       return OMX_COLOR_FormatYVU420Planar;
    }
    ...
    if (!strcmp(colorFormat, CameraParameters::PIXEL_FORMAT_YUV420SP)) {
        return OMX_COLOR_FormatYVU420SemiPlanar;
    }
	...
	//Actions Fix for Camera Hal 1.0	
    if (!strcmp(colorFormat, "yuv420sp_nv12")) {
        ALOGD("yuv420sp_nv12 det ok,so OMX_COLOR_FormatYUV420SemiPlanar return");
        return OMX_COLOR_FormatYUV420SemiPlanar;
    }

    if (!strcmp(colorFormat, "yuv420p_yu12")) {
        ALOGD("yuv420p_yu12 det ok, so OMX_COLOR_FormatYUV420Planar return");
