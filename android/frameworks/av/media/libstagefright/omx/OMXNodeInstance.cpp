...
struct BufferMeta {
    ...
    void CopyFromOMX(const OMX_BUFFERHEADERTYPE *header) {
        ...
        /*ActionsCode(author:sunchengzhi,fix cts com.android.cts.videoperf.VideoEncoderDecoderTest)*/
        if(header->nFlags&0x80000000){
        	memcpy((OMX_U8 *)mMem->pointer(),
    ...
    /*ActionsCode(author:sunchengzhi,fix cts com.android.cts.videoperf.VideoEncoderDecoderTest)*/
    bool IsBackup(){ return mIsBackup; }
...
void OMXNodeInstance::onMessage(const omx_message &msg) {
    ...
    if (msg.type == omx_message::FILL_BUFFER_DONE) {
        ...
        /*ActionsCode(author:sunchengzhi,fix cts com.android.cts.videoperf.VideoEncoderDecoderTest)*/
        if((buffer->nFlags&0x80000000)&&buffer_meta->IsBackup()){
        	buffer->nOffset = 0;
        	OMX_U32 *pst = const_cast<OMX_U32 *>(&msg.u.extended_buffer_data.range_offset);
        	*pst  = 0;
				}
