...
/**
  *
  *ActionsCode(author:xuejingsong, change_code)
  */
SoftG711::SoftG711(
        const char *name,
    ...
    : SimpleSoftOMXComponent(name, callbacks, appData, component),
      mIsMLaw(true),
      mNumChannels(1),
      mSampleRate(8000),/*ActionsCode(author:xuejingsong,init mSampleRate to 8K)*/
...
OMX_ERRORTYPE SoftG711::internalGetParameter(
    ...
    switch (index) {
        case OMX_IndexParamAudioPcm:
        {
            ...
            pcmParams->nSamplingRate = mSampleRate/*8000*/;/*ActionsCode(author:xuejingsong,use actual sampleRate instead  of fixed 8k sampleRate)*/
    ...
    switch (index) {
        case OMX_IndexParamAudioPcm:
        {
            ...
            if(pcmParams->nPortIndex == 0) {
                ...
                mSampleRate = pcmParams->nSamplingRate;/*ActionsCode(author:xuejingsong,get actual SampleRate)*/
            }
