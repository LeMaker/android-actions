...
/*
  * use inHeader->nTimeStamp to as condition when seek happen
  ************************************
  *      
...
void SoftMP3::onQueueFilled(OMX_U32 /* portIndex */) {
    ...
    while ((!inQueue.empty() || (mSawInputEos && !mSignalledOutputEos)) && !outQueue.empty()) {
        ...
        if (inHeader) {
        	/*ActionsCode(author:jinsongxue, use inHeader->nTimeStamp to as condition)*/
            if (inHeader->nOffset == 0 && inHeader->nTimeStamp) {
