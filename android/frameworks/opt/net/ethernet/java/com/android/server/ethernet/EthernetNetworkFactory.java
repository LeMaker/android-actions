...
class EthernetNetworkFactory {
    ...
    /*ActionsCode(zyl, new_method),for  usb ethernet sendBroadcast */
    private void setEthernetState(int ethernetState) {   
	       final int previousState = mEthernetState.get();
	       mEthernetState.set(ethernetState);
		     ...
		     intent.putExtra(EthernetManager.EXTRA_PREVIOUS_ETHERNET_STATE,previousState);
    ...
    private void updateInterfaceState(String iface, boolean up) {
        ...
        synchronized(this) {
            ...
            /*ActionsCode(zyl, change_code),for usb ethernet up and down sendBroadcast */
            if(up){
                setEthernetState(ETHERNET_STATE_ENABLED);	
                Log.d(TAG, "setEthernetState  ETHERNET_STATE_ENABLED sendBroadcast");
            }
            else{
                setEthernetState(ETHERNET_STATE_DISABLED);	
                Log.d(TAG, "setEthernetState ETHERNET_STATE_DISABLED sendBroadcast");
            }
        }
    }
