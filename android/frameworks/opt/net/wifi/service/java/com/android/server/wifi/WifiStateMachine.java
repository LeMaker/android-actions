...
public class WifiStateMachine extends StateMachine {
    ...
    */
    ...
    private boolean mSoftApChange = false;
    private final PowerManager.WakeLock mSoftApWakeLock;
    private final PowerManager.WakeLock mStartedWakeLock; 
   ...
   /* Set the frequency band */
     ...
     */
    private int mDriverStopDelayMs;
    ...
    public WifiStateMachine(Context context, String wlanInterface,
        ...
        mStartedWakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "WifiStarted");
        mStartedWakeLock.setWorkSource(null);

        mSoftApWakeLock = powerManager.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "SoftAp");
        mSoftApWakeLock.setReferenceCounted(false);
    ...
    private void handleScreenStateChanged(boolean screenOn, boolean startBackgroundScanIfNeeded) {
        ...
        //fix android reboot bug for dark screen 20141121
    ...
    class InitialState extends State {
        ...
        public void enter() {
            ...
            if(wifi_modules != null && !wifi_modules.isEmpty() && wifi_modules.equals("RMMOD_WLAN_KO")) {
                if (mIsWakeLock == true)
                {
                    if (DBG) log("--- InitialState: mStartedWakeLock.release() ---" );
                    mStartedWakeLock.release();
                    mIsWakeLock = false;
                }
            }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case CMD_START_SUPPLICANT:
                    ...
                    if(wifi_modules != null && !wifi_modules.isEmpty() && wifi_modules.equals("RMMOD_WLAN_KO")) {
                        if (mIsWakeLock == false)
                        {
                            if (DBG) log("--- InitialState: mStartedWakeLock.acquire() ---" );
                            mIsWakeLock = true;
                            mStartedWakeLock.acquire();
                        }
                    }
                ...
                case CMD_START_AP:
                    if (mWifiNative.loadDriver()) {
                        mSoftApWakeLock.acquire();//by alic 2014-09-23
    ...
    class DriverStartedState extends State {
        ...
        public boolean processMessage(Message message) {
            ...
            switch(message.what) {
                case CMD_START_SCAN:
                    /* 'RMMOD_WLAN_KO' use for broadcom modules. 
                     * When using broadcom module, p2p connected and not Setting interface does not scan */
                    if ((wifi_modules != null && !wifi_modules.isEmpty() && wifi_modules.equals("RMMOD_WLAN_KO")) &&
                         mP2pConnected.get() && (message.arg1 == SCAN_ALARM_SOURCE || message.arg1 == UNKNOWN_SCAN_SOURCE)) {
                    } else {
                ...
                case CMD_STOP_DRIVER:
                    ...
                    if(wifi_modules != null && !wifi_modules.isEmpty() && wifi_modules.equals("RMMOD_WLAN_KO")) {
                        mDriverStopDelayMs = 30 * 1000;    //delay stop driver 30s
                    }
        ...
        public boolean processMessage(Message message) {
            ...
            switch(message.what) {
                ...
                case CMD_STOP_AP:
                    ...
                    stopTethering();
                    mSoftApWakeLock.release();//by alic 2014-09-23
