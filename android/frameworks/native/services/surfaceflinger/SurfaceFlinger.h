...
private:
    ...
    //ActionsCode(liuxinxu, NEW_FEATURE : support hw rotation)
#if ACTIONS_FEATURE_HW_ROTATION_DEFAULT_ON
    void convertCropBoundsAndRotation(Rect& sourceCrop, uint32_t hw_h, uint32_t hw_w, int hwOrientation,
