...
status_t HWComposer::queryDisplayProperties(int disp) {
    ...
    if(disp == HWC_DISPLAY_EXTERNAL 
    	&& mFlinger->sPropertiesState.mHdmiDefaultFormat == PIXEL_FORMAT_RGB_565){
    		mDisplayData[disp].format = HAL_PIXEL_FORMAT_RGB_565;
    }else{
...
public:
    ...
    //ActionsCode(wh, NEW_FEATURE : add for android sence detected,called by layer.cpp)
