...
public:
    ...
    virtual bool isProtected() const;
     ...
     /*
     * isVideoOn - true if the layer may contain video content in the
     * GRALLOC_USAGE_HW_VIDEO sense.
     * ActionsCode(wh, new_method)
     */
    virtual bool isVideoOn() const;
#endif
    /*
...
#if ACTIONS_FEATURE_SENCE_DETECTED_DEFAULT_ON    
    //ActionsCode(wh, NEW_FEATURE : add for android sence detected)
    int  mLayerFlags;
#endif 
    // protected by mLock
    mutable Mutex mLock;
