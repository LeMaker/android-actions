...
static const TracingCategory k_categories[] = {
    ...
    { "disk",       "Disk I/O",         0, {
        ...
        { REQ,      "/sys/kernel/debug/tracing/events/ext4/ext4_read_block_bitmap_load/enable" },
        { REQ,      "/sys/kernel/debug/tracing/events/ext4/ext4_readpage/enable" },
        { REQ,      "/sys/kernel/debug/tracing/events/ext4/ext4_readpages/enable" }, 
        { REQ,      "/sys/kernel/debug/tracing/events/ext4/ext4_request_blocks/enable" },
        { REQ,      "/sys/kernel/debug/tracing/events/ext4/ext4_request_inode/enable" },
        ...
        { REQ,      "/sys/kernel/debug/tracing/events/filemap/mm_filemap_add_to_page_cache/enable" },
        { REQ,      "/sys/kernel/debug/tracing/events/filemap/mm_filemap_delete_from_page_cache/enable" },
    } },
    { "mmc",        "eMMC commands",    0, {
