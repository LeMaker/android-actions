...
/*ActionsCode(author:liushijun, change code)*/
#ifndef MAX_EGL_CACHE_SIZE
//ActionsCode(liushijun, OPTIMIZE:optimize game once again loading perfermance)
#define MAX_EGL_CACHE_SIZE (1024 * 1024);
#endif
