...
public class Activity extends ContextThemeWrapper
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
		/*
		    turning screen to SCREEN_ORIENTATION_PORTRAIT for following cts item:
			package: android.tests.appsecurity
			class: com.android.cts.documentclient.MyActivity
			method: testCreateExisting()
		*/
		final String clsName = "com.android.cts.documentclient.MyActivity";
		if (getClass().getName().equals(clsName)) {
    ...
    public void onBackPressed() {
        ...
        // ActionsCode(authro:songzhining, comment: fix BUG00243590)
        try {
            if (!mFragments.popBackStackImmediate()) {
                finishAfterTransition();
            }
        } catch (IllegalStateException e) {
            Log.w(TAG, "popBackStackImmediate() exception!" + e);
        }
    }
