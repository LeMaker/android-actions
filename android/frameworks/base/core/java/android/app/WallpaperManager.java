...
public class WallpaperManager {
    ...
    static class Globals extends IWallpaperManagerCallback.Stub {
		...
		/*
		 *BUGFIX:get wallpaper size to avoid wallpaper scale in rotation
		 *
		 *ActionsCode(author:fanguoyong,change code)
		 */
        private Bitmap getCurrentWallpaperLocked(Context context) {
            ...
            try {
                ...
                if (fd != null) {
					//ActionsCode(author:fanguoyong,get wallpaper size)
 					int width = params.getInt("width", 0);
                    int height = params.getInt("height", 0);
                    try {
                        BitmapFactory.Options options = new BitmapFactory.Options();
						//ActionsCode(author:fanguoyong,generate wallpaper in size)
        ...
        private Bitmap getDefaultWallpaperLocked(Context context) {
            ...
            if (is != null) {
				...
				try {
					...
					Log.w(TAG, "Can't get wallpaper size", e);
				}
	...
	/*
	 *BUGFIX: generate wallpaper bitmap
	 ********************************
	 *ActionsCode(author:fanguoyong,new method)
	 */
