...
public final class ActivityThread {
    ...
    private void setupGraphicsSupport(LoadedApk info, File cacheDir) {
        ...
        try {
            ...
            }else if (packages != null &&  packages.length >1 && uid<Process.FIRST_APPLICATION_UID){ 
                //actions_code(ywwang, cache shader program for system application ... 
                //todo: figurate out  why must packages.length ==1? 
                HardwareRenderer.setupDiskCache(cacheDir); 
            }
        } catch (RemoteException e) {
            // Ignore
