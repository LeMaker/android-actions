...
public abstract class ActivityInstrumentationTestCase2<T extends Activity> 
    ...
    protected void setUp() throws Exception {
        ...
        callHookForInstrumentTest(true);
    }
    ...
    protected void tearDown() throws Exception {
        ...
        callHookForInstrumentTest(false);
    }

    /**
    * Fixing cts5.0_r2 bug: testRandomUpdate
    */
    private void callHookForInstrumentTest(boolean start) {
        final String clsName1 = "com.android.cts.filesystemperf.AlmostFullTest";
        final String clsName2 = "com.android.cts.filesystemperf.RandomRWTest";
        final String flushEn = "/proc/nanddisk/flush";

        // disable nand flush for cts filesystemperf test
        //Log.w("callHookForInstrumentTest", "start testing");
        if (getClass().getName().equals(clsName1) || getClass().getName().equals(clsName2)) {
            //Log.w("callHookForInstrumentTest", "testing: " + getClass().getName());
            try {
                FileOutputStream out = new FileOutputStream(flushEn);
                if (start) {
                ...
                //Log.e("callHookForInstrumentTest", "write " + flushEn +" error!");
                e.printStackTrace();
            }
        }
    }
