...
final class LogicalDisplay {
    ...
    public void configureDisplayInTransactionLocked(DisplayDevice device,
        ...
        //ActionsCode(author:wh, comment:new feature make hdmi and wfd full screen)
        displayRectWidth = physWidth;
        displayRectHeight = physHeight;        
        if(ActionsConfig.ACTIONS_FEATURE_HDMI_FULL_SCREEN_DEFAULT_ON == 0 || displayDeviceInfo.type != Display.TYPE_HDMI){
