...
class WindowStateAnimator {
    ...
    SurfaceControl createSurfaceLocked() {
        ...
        if (mSurfaceControl == null) {
            ...
            try {
                ...
                int format = isHwAccelerated ? PixelFormat.TRANSLUCENT : attrs.format;
                //actions_code(ywwang, import starting window rendering)
                if((attrs.format==PixelFormat.RGB_565)&&(
                    attrs.type==WindowManager.LayoutParams.TYPE_APPLICATION_STARTING)){
                        format=attrs.format;
                }
    ...
    void computeShownFrameLocked() {
        ...
        //ActionsCode(author:wh, BUGFIXED:BUG00252867 make sure stop crop animation after animation end )
        mHasClipRect = false;
