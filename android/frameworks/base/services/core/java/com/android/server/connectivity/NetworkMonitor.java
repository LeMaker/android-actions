...
public class NetworkMonitor extends StateMachine {
    ...
    //actions_code(author:lichenchen, wifi and 3g dongle priority)
    //0,no fake ;1,fake
    private int mNetwork3gTestResultIsFake = 0; 	
    ...
    private class ValidatedState extends State {
        ...
        public void enter() {
            ...
            mConnectivityServiceHandler.sendMessage(obtainMessage(EVENT_NETWORK_TESTED,
                    NETWORK_TEST_RESULT_VALID, mNetwork3gTestResultIsFake, mNetworkAgentInfo));
        }
        ...
        public boolean processMessage(Message message) {
            ...
            switch (message.what) {
                case CMD_REEVALUATE:
                    ...
                    //ActionsCode(author:lichenchen, change_code:3g always return 204) 
                    int networkType = mNetworkAgentInfo.networkInfo.getType();
                    log("isCaptivePortal,networkType:" + networkType);				
                    if ((204 != httpResponseCode) && (ConnectivityManager.TYPE_MOBILE == networkType)){
                        log("204 != httpResponseCode , ConnectivityManager.TYPE_MOBILE"); 
                        mNetwork3gTestResultIsFake = 1;//fake
                        transitionTo(mValidatedState);
                        return HANDLED;
                    }

                    mNetwork3gTestResultIsFake = 0;//actual
