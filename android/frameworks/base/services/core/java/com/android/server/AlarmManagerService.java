...
class AlarmManagerService extends SystemService {
    ...
    void setImpl(int type, long triggerAtTime, long windowLength, long interval,
    	...
    	/**
    	 *actions_code(ywwang, ACTIONS_OPT_ALARM_FORCE_OFF)
    	 *
    	 *ywwang :reject some app's request of wakeup system from sleep state to save battery
    	 */
    	type=com.actions.hooker.HookAlarmTypeCaller.callHookAlarmType(getContext(), type);
