 ...
 *************************************************
 *  ActionsCode(authro:huoysh,change_code)
 */
class MountService extends IMountService.Stub
    ...
    //ActionsCode(authro:huoysh,change_code, comment: saved state for unmounting)
    private String mVolumeStateSaved = Environment.MEDIA_UNMOUNTED;
...
*/
	...
	*/
    private void readStorageListLocked() {
        ...
        //ActionsCode(authro:huoysh,change_code, comment: add for emulated sdcard)
        ...
        try {
            ...
            while (true) {
                ...
                if (TAG_STORAGE.equals(element)) {
                    ...
                    //ActionsCode(authro:huoysh,change_code, comment: add for emulated sdcard)
                    if (primary && fuseSdcard.equals("true")) {
                        emulated = true;
                    }
        ...
        synchronized (mVolumesLock) {
            ...
            if (state == null) {
                ...
                if (SystemProperties.get("vold.encrypt_progress").length() != 0) {
					...
					//ActionsCode(huoysh, sync from gs702c_4.4.4) 
                    //throw new IllegalArgumentException();  // avoid crashed when emulated sdcard
                    Slog.w(TAG, "throw new IllegalArgumentException()");
                }
            }
