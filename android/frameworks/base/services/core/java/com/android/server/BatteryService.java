...
public final class BatteryService extends SystemService {
    ...
    private void shutdownIfNoPowerLocked() {
		...
		/* only when battery exists and usb is plugged,does system shutdown
		 * ActionsCode(author:cxj,change_code)
		*/
        if (mBatteryProps.batteryPresent && (mBatteryProps.batteryLevel == 0) && !isPoweredLocked(BatteryManager.BATTERY_PLUGGED_AC | BatteryManager.BATTERY_PLUGGED_WIRELESS)) {
