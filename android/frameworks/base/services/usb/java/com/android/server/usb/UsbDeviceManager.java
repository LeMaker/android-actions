...
public class UsbDeviceManager {
    ...
    private final UEventObserver mUEventObserver = new UEventObserver() {
        ...
        public void onUEvent(UEventObserver.UEvent event) {
            ...
            //ActionsCode(authro:songzhining, comment: shutdown from usb drv)
            String mach_state = event.get("MACHINE_STATE");
            if (mach_state != null && "SHUTDOWN".equals(mach_state)) {
                Slog.w(TAG, "Shutdown request from usb drv");
    ...
    private final class UsbHandler extends Handler {
		...
		*/
        ...
        private void updateUsbNotification() {
			//ActionsCode(huoysh, fix notification for ums and mtp) 			
            ...
            if (mConnected) {
                if (containsFunction(mCurrentFunctions, UsbManager.USB_FUNCTION_MTP)) {
                    ...
                    // There is a different notification for USB Mass storage so we don't need one here
