...
public class RingtonePlayer extends SystemUI {
    ...
    private Context getContextForUser(UserHandle user) {
        try {
            ...
            // ActionsCode(authro:songzhining, comment: fix BUG00359982, fix NPE when playing sound on boot)
            ApplicationInfo appInfo = mContext.getApplicationInfo();
            Log.w(TAG, "getApplicationInfo(appInfo=" + appInfo + ")");
            try {
                return mContext.createApplicationContext(appInfo, Context.CONTEXT_RESTRICTED);
