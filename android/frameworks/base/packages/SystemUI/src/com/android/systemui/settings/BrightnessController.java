...
public class BrightnessController implements ToggleSlider.Listener {
    private static final String TAG = "StatusBar.BrightnessController";
		/**
		  ...
		  ************************************    
		  *ActionsCode(author:fanguoyong, add mIntelligentSettingsName in SettingsProvide)
		  */    
    ...
    private class BrightnessObserver extends ContentObserver {
		...
		/**
		  *
		  *NEW_FEATURE:
		  *add intelligent backlight control for statusbar,get configure in 
    ...
    public BrightnessController(Context context, ImageView icon, ToggleSlider control) {
        ...
        //ActionsCode(author:fanguoyong, change to R.bool.config_intelligent_brightness_available)
    ...
    public void onChanged(ToggleSlider view, boolean tracking, boolean automatic, int value) {
    	 	//ActionsCode(author:fanguoyong, update Icon)
    ...
    private void updateMode() {
        if (mAutomaticAvailable) {
            ...
            */
            //ActionsCode(author:fanguoyong, read mIntelligentSettingsName from ContentResolver)
            automatic = Settings.System.getIntForUser(mContext.getContentResolver(),
    ...
    private void updateSlider() {
				//ActionsCode(author:fanguoyong,disable SCREEN_AUTO_BRIGHTNESS_ADJ)
        //if (mAutomatic) {
        if (false) {
