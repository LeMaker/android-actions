...
public class PhoneStatusBar extends BaseStatusBar implements DemoMode,
    ...
    protected PhoneStatusBarView makeStatusBarView() {
         ...
         *ActionsCode(author:fanguoyong, change_code)
         */
				mScreenRecordController = new ScreenRecordController(mContext);
        ...
        if (mQSPanel != null) {
            final QSTileHost qsh = new QSTileHost(mContext, this,
                    ...
                    mSecurityController,
                    /*ActionsCode(author:fanguoyong, change_code)*/mScreenRecordController);
    ...
    public void setInteracting(int barWindow, boolean interacting) {
        ...
        //ActionsCode(fanguoyong,disable this function because we use virtual VolumeKey)
    ...
    private void addStatusBarWindow() {
		...
		/*
		 *BUGFIX:BUG00249897
		 *force SystemUI to draw with HardwareAccelerated
		 *ActionsCode(author:fanguoyong, bug_fix)
		 */
		HardwareRenderer.sRendererDisabled = false; 
    ...
    public void userSwitched(int newUserId) {
        ...
        resetUserSetupObserver();
        setControllerUsers();
		//ActionsCode(fanguoyong,BUGFIX:BUG00280171) stop screenrecord when userswitched
		if(mScreenRecordController.isScreenRecording()) {
