...
public class LocationControllerImpl extends BroadcastReceiver implements LocationController {
    ...
    private int mDefaultLocationMode;
    ...
    public LocationControllerImpl(Context context) {
        ...
        if (gpsEnabled) {
            mDefaultLocationMode = Settings.Secure.LOCATION_MODE_HIGH_ACCURACY;
        } else {
            mDefaultLocationMode = Settings.Secure.LOCATION_MODE_BATTERY_SAVING;
        }
    }
    ...
    public boolean setLocationEnabled(boolean enabled) {
        ...
        int mode = enabled
                ? mDefaultLocationMode : Settings.Secure.LOCATION_MODE_OFF;
