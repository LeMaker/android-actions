...
public class BatteryMeterView extends View implements DemoMode,
    ...
    private static final int FULL = 96;
		/**
  	*BUGFIX:BUG00216906 
  	*show battery icon like "?" when in short-circuit mode(battery level = -99).when in factory,it 
  	* may cause battery short-circuit,so add this status icon to inform it.
  	************************************
  	*      
  	*ActionsCode(fanguoyong, change_code)
  	*/
		private static final int SHORT = -99;
    ...
    public void draw(Canvas c) {
        ...
        //ActionsCode(fanguoyong, bugfix BUG00216906)
        if (tracker.plugged && level != SHORT) {
        ...
        if (level == SHORT) {
            ...
            c.drawText("?", x, y, mWarningTextPaint);   
				}
