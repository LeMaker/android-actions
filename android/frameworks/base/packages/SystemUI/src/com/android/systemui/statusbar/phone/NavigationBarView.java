...
//ActionsCode(fanguoyong,add virtual Volume button)
...
public class NavigationBarView extends LinearLayout {
    ...
    /**
  	*NEW_FEATURE: add virtual Volume button
  	*mVolumeDisplayFlag: read "ro.systemui.volumekey" from build.prop
  	*"ro.systemui.volumekey = enable",show virtual Volume key
  	*"ro.systemui.volumekey = disable",don't show virtual Volume key
  	* default "ro.systemui.volumekey = enable"  
  	*******************************   
  	*ActionsCode(author:fanguoyong, add_code)
  	*/
    private boolean mVolumeDisplayFlag;
    ...
    public NavigationBarView(Context context, AttributeSet attrs) {
        ...
        /**
  			*NEW_FEATURE: add virtual Volume button
				*read "ro.systemui.volumekey" from build.prop
  			*default "ro.systemui.volumekey = enable"     
  			**************************
  			*
  			*ActionsCode(author:fanguoyong, add_code)
  			*/
        mVolumeDisplayFlag = SystemProperties.get("ro.systemui.volumekey", "enable").equals("enable");
    }
    ...
    /**
  	*NEW_FEATURE: add virtual Volume button
  	*add new_method to get VolumeButton
  	*
  	************************************
  	*      
  	*ActionsCode(fanguoyong, new_method)
  	*/
	...
	/*
	 *BUGFIX:BUG00240495
	 *inflate rotatedView according to Configuration.ORIENTATION_LANDSCAPE instead of rotation
	 ******************************
	 *ActionCode(author:fanguoyong,change code)
	 */
    @Override
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        mDelegateHelper.setInitialTouchRegion(getHomeButton(), getBackButton(), getRecentsButton(),getVolumeUpButton(), getVolumeDownButton());
    }
