...
public class NetworkControllerImpl extends BroadcastReceiver
	...
	//ActionsCode(fanguoyong,add EthernetIcon)
	private int mEthernetIconId = -1;
    ...
    private void registerListeners() {
         ...
         *NEW_FEATURE: add ethernet icon on systemUI
     	 *ActionsCode(author:fanguoyong, add ethernet boardcast to receive)
     	 */
    ...
    public boolean hasMobileDataFeature() {
		//ActionsCode(fanguoyong,do not show CellularTile in QS)
    ...
    public void onReceive(Context context, Intent intent) {
		...
		/*
         *NEW_FEATURE: add ethernet icon on systemUI
     	 *ActionsCode(author:fanguoyong, handle ethernet boardcast)
     	 */
     	else if(action.equals(EthernetManager.ETHERNET_STATE_CHANGED_ACTION)){
            updateEthernetMode(intent);      
        } else {
	 ...
	 ************************************
	 *      
	 *ActionsCode(author:fanguoyong, new_method:updateEthernetIcons)
	 */
    private void updateEthernetMode(Intent intent) {
    ...
    private void notifyListeners() {
        ...
        for (int i = 0; i < length; i++) {
			...
			//ActionsCode(fanguoyong,notify for ethernet)
			mSignalClusters.get(i).setEthernetIndicators(mEthernetIconId);
        }
    ...
    private void updateConnectivity() {
		...
		//ActionsCode(fanguoyong,add Ethernet icon)
		updateEthernetMode(null);
        pushConnectivityToSignals();
    }
    ...
    public interface SignalCluster {
        ...
        void setIsAirplaneMode(boolean is, int airplaneIcon, int contentDescription);
         /**
		 *NEW_FEATURE: add ethernet icon on systemUI     
		 *ActionsCode(author:fanguoyong, add a new interface,override in SignalClusterView.java)
		 */
         void setEthernetIndicators(int strengthIcon);
    }
