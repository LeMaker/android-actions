...
public class RotationLockTile extends QSTile<QSTile.BooleanState> {
	private static final String TAG = "RotationLockTile";
    ...
    public RotationLockTile(Host host) {
	 ...
	 /*NEW_FEATURE: QSTileHost default rotate  auto_rotatation or  landscape config by  android.prop
      *ActionsCode(author:chenhaoxu, QSTileHost default rotate  auto_rotatation or  landscape config by  android.prop )
	 */
	 
		boolean auto_rotate  = SystemProperties.getBoolean("ro.auto_rotate", false);
