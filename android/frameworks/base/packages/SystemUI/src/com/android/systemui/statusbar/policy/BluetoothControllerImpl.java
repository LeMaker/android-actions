...
public class BluetoothControllerImpl implements BluetoothController {
    ...
    public void setBluetoothEnabled(boolean enabled) {
	 ...
	 /**
	  *
	  *BUGFIX : show bluetooth button in system ui according to FEATURE_BLUETOOTH
	  *show or hide bluetooth button in systemUI according to FEATURE_BLUETOOTH/FEATURE_BLUETOOTH_LE
	  * and property "ro.settings.support.bluetooth".
	  *
	  ************************************
	  *      
	  *ActionsCode(author:fanguyong, change_code)
	  */
    @Override
    public boolean isBluetoothSupported() {
    //ActionsCode(author:fanguoyong, change_code)
    boolean bluetoothproperty = SystemProperties.get("ro.settings.support.bluetooth", "false").equals("true")
    ...
    return (mAdapter != null) && bluetoothproperty;
    //return mAdapter != null;
    }
