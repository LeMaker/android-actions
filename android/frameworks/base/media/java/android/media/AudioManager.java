...
/**
 *BUGFIX: BUG000127393
 *Key: no sound played when on key operation. it's the original designed, modified to fulfill 
 *client needs.
 ************************************
 *      
...
public class AudioManager {
    ...
    //ActionsCode(author:yuchen, change_code): add var to flag configuration.
    private static final boolean mPlayVolumeKeySounds = SystemProperties.getInt("ro.config.volkey_sound", 0) > 0;    
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_VOLUME_DOWN:
                ...
                if (mUseVolumeKeySounds) {
                    ...
                    //ActionsCode(author:yuchen, change_code)
                    //ActionsCode(authro:songzhining, comment: fix BUG00127393
                    if (mPlayVolumeKeySounds) {
