...
class GlobalActions implements DialogInterface.OnDismissListener, DialogInterface.OnClickListener  {
    ...
    //ActionsCode(liuxinxu, NEWFEATURE: Add restart and recovery item),
    ...
    ************************************
    *      
    *ActionsCode(author:liuxinxu, change_code: Add restart and recovery item in global actions dialog)
    */
    ...
    private GlobalActionsDialog createDialog() {
        ...
        //ActionsCode(liuxinxu, NEWFEATURE: Add restart and recovery item in global actions dialog),
        for (int i = 0; i < defaultActions.length; i++) {
            ...
            if (GLOBAL_ACTION_KEY_POWER.equals(actionKey)) {
            	...
            	if(SystemProperties.get("ro.shutmenu.restart", "disable").equals("enable")) {
            		mItems.add(new ReStartAction());
            	}
            } else if (GLOBAL_ACTION_KEY_RECOVERY.equals(actionKey)) {
            	if(SystemProperties.get("ro.shutmenu.recovery", "disable").equals("enable")) {
    ...
    ************************************
    *      
    *ActionsCode(liuxinxu, new_method: ReStartAction)
    */
    ...
    ************************************
    *      
    *ActionsCode(liuxinxu, new_method: RecoveryAction)
    */
    private final class RecoveryAction extends SinglePressAction {
        private RecoveryAction() {
            super(com.android.internal.R.drawable.ic_lock_power_off,
                R.string.global_action_reboot_to_recovery);
        }
        ...
        public void onPress() {
        	try {
        		...
        		RecoverySystem.bootCommand(mContext, arg);
        	} catch(Exception e) {
