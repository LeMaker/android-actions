...
enum {
    ...
    HWC_SURFACEVIEW_LAYER = 0x00000100,
    HWC_VIDEO_LAYER = 0x00000200,
    HWC_BROWSER_LAYER = 0x00000400,
    HWC_PROTECTED_LAYER = 0x00000800,
    HWC_CAMERA_LAYER = 0x00001000,
    HWC_SYSTEMUI_LAYER = 0x00010000,
    HWC_UI_CHANGED_LAYER = 0x00020000,
};
