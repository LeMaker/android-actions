...
#ifdef __TARGET_IS_64_BIT
/**
 * actions_code(lishiyuan, bugfix: if cpu is 64 bit, don't use neon to optimize 
 * sample function)
 */
#undef ACTIONS_OPT_SAMPLE_USE_NEON
#endif

#if ACTIONS_OPT_SAMPLE_USE_NEON == 1
/**
 * actions_code(lishiyuan, optimize: make png-decoding faster, use neon to 
 *optimize sample fuction)
 */

extern "C" bool Sample_Gray_D8888_neon(void* SK_RESTRICT dstRow,
                              const uint8_t* SK_RESTRICT src,
                              int width, int deltaSrc, int, const SkPMColor[]); 
extern "C" bool Sample_RGBx_D8888_neon(void* SK_RESTRICT dstRow,
                              const uint8_t* SK_RESTRICT src,
                              int width, int deltaSrc, int, const SkPMColor[]);
extern "C" bool Sample_RGBA_D8888_neon(void* SK_RESTRICT dstRow,
                              const uint8_t* SK_RESTRICT src,
                              int width, int deltaSrc, int, const SkPMColor[]);
extern "C" bool Sample_Index_D8888_neon(void* SK_RESTRICT dstRow,
                               const uint8_t* SK_RESTRICT src,
                       int width, int deltaSrc, int, const SkPMColor ctable[]);
extern "C" bool Sample_RGBA_D8888_Unpremul_neon(void* SK_RESTRICT dstRow,
                                       const uint8_t* SK_RESTRICT src,
                                       int width, int deltaSrc, int, const SkPMColor[]);
									   
extern "C" {
    SkPMColor SkPreMultiplyARGB2(U8CPU a, U8CPU r, U8CPU g, U8CPU b) {
...
#if (ACTIONS_OPT_SAMPLE_USE_NEON == 1) && defined(__ARM_HAVE_NEON) && defined(SK_CPU_LENDIAN)
