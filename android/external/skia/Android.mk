...
USE_ANDROID_DEFAULT_CODE := false

ifeq ($(USE_ANDROID_DEFAULT_CODE), true)
LOCAL_CFLAGS += -DANDROID_DEFAULT_CODE
endif

ifeq ($(TARGET_IS_64_BIT),true)
LOCAL_CFLAGS += -D__TARGET_IS_64_BIT
endif

ACTIONS_OPT_SAMPLE_USE_NEON := 1
...
ifeq ($(USE_ANDROID_DEFAULT_CODE), false)
LOCAL_SRC_FILES += src/images/SkImageDecoder_Act.cpp
LOCAL_SRC_FILES += src/images/SkImageDecoder_Act_libbmp.cpp 
else
LOCAL_SRC_FILES += src/images/SkImageDecoder_libbmp.cpp 
endif	
...
ifeq ($(ACTIONS_OPT_SAMPLE_USE_NEON),1)
	ifneq ($(TARGET_IS_64_BIT),true)
		LOCAL_STATIC_LIBRARIES += libskia_actions_opt
	endif
endif
