...
void SBC_Encoder_Init(SBC_ENC_PARAMS *pstrEncParams)
{
    ...
    {
		if (0 == pstrEncParams->s16NumOfBlocks) {
			ALOGE("SBC_Encoder_Init ERROR 1: div 0");
			ALOGI("s16SamplingFreq:%d", pstrEncParams->s16SamplingFreq);
			ALOGI("s16ChannelMode:%d", pstrEncParams->s16ChannelMode);
			ALOGI("s16NumOfSubBands:%d", pstrEncParams->s16NumOfSubBands);
			ALOGI("s16NumOfChannels:%d", pstrEncParams->s16NumOfChannels);
			ALOGI("s16NumOfBlocks:%d", pstrEncParams->s16NumOfBlocks);
			ALOGI("s16AllocationMethod:%d", pstrEncParams->s16AllocationMethod);
			ALOGI("s16BitPool:%d", pstrEncParams->s16BitPool);
			ALOGI("u16BitRate:%d", pstrEncParams->u16BitRate);
			ALOGI("u8NumPacketToEncode:%d", pstrEncParams->u8NumPacketToEncode);
			pstrEncParams->s16NumOfBlocks = 4;
		}
		...
		if ((0 == pstrEncParams->s16NumOfSubBands) || (0 == pstrEncParams->s16NumOfBlocks)) {
			ALOGE("SBC_Encoder_Init ERROR 2: div 0");
			ALOGI("s16SamplingFreq:%d", pstrEncParams->s16SamplingFreq);
			ALOGI("s16ChannelMode:%d", pstrEncParams->s16ChannelMode);
			ALOGI("s16NumOfSubBands:%d", pstrEncParams->s16NumOfSubBands);
			ALOGI("s16NumOfChannels:%d", pstrEncParams->s16NumOfChannels);
			...
			if (0 == pstrEncParams->s16NumOfSubBands) {
				pstrEncParams->s16NumOfSubBands = 4;
			}
    ...
    {
		if ((0 == pstrEncParams->s16NumOfChannels) || (0 == pstrEncParams->s16NumOfBlocks)) {
			ALOGE("SBC_Encoder_Init ERROR 3: div 0");
			ALOGI("s16SamplingFreq:%d", pstrEncParams->s16SamplingFreq);
			ALOGI("s16ChannelMode:%d", pstrEncParams->s16ChannelMode);
			ALOGI("s16NumOfSubBands:%d", pstrEncParams->s16NumOfSubBands);
			ALOGI("s16NumOfChannels:%d", pstrEncParams->s16NumOfChannels);
			...
			if (0 == pstrEncParams->s16NumOfChannels) {
				pstrEncParams->s16NumOfChannels = 1;
			}
