...
void PictureLayerImpl::UpdateTiles() {
  //ActionsCode(author:hexibin, remove large quantity of systrace tag)
...
void PictureLayerImpl::MarkVisibleResourcesAsRequired() const {
  ...
  //ActionsCode(hexibin, bugfix BUG00259066)
  if(high_res == NULL){
    VLOG(0) << "error, PictureLayerImpl::MarkVisibleResourcesAsRequired high_res null!";
    return;
  }
