...
/**
 * 2014-12-09 add macro for debug
 *
 ************************************
 *      
...
/**
  *2015-1-10 the subtitle track may contain encoding content,
  			which should not be recognized as an error
  ************************************
  *      
  *ActionsCode(author:rongxing, change_code)
  */
long Tracks::ParseTrackEntry(long long track_start, long long track_size,
  ...
  if (info.type == Track::kVideo) {
    ...
    if (v.start >= 0)
      return E_FILE_FORMAT_INVALID;
	/*ActionsCode(author:rongxing,  the subtitle track may contain encoding content,
  	which should not be recognized as an error)*/
    //if (e.start >= 0)
    //  return E_FILE_FORMAT_INVALID;
...
/**
 * 2014-12-09 fix bug for some mkv file
 * whose BlockGroup may not contain any
 * audio or video data.when we parser this 
 * BlockGroup,we just skip it
 ************************************
 *      
 *ActionsCode(author:rongxing , change_code)
*/
long Cluster::ParseBlockGroup(long long payload_size, long long& pos,
  ...
  const long long payload_stop = pos + payload_size;
  //ActionsCode(rongxing, skip the BlockGroup which doesnot contain audio or video data)
